...
public class ItemControllerTest {
    ...
    void testGetAllOwnerItems() throws Exception {
        Mockito
                .when(itemService.getAllUserItemsDto(Mockito.anyLong())).thenReturn(new ArrayList<>());
        mvc.perform(get("/items")
                ...
                .andExpect(status().isOk())
                .andDo(print());
        Mockito.verify(itemService).getAllUserItemsDto(1L);
    }
    ...
    void testSearchItems() throws Exception {
        ...
        mvc.perform(get("/items/search?text=text")
                ...
                .andExpect(status().isOk())
                .andDo(print());
        Mockito.verify(itemService).searchItemsDto(text, 1L);
    }
